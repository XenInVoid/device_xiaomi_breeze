...
PRODUCT_BUILD_PROP_OVERRIDES += \
    BuildDesc="breeze-user 15 AQ3A.240912.001 OS2.0.3.0.VNUINXM release-keys" \
    BuildFingerprint=POCO/breeze_p_in/breeze:15/AQ3A.240912.001/OS2.0.3.0.VNUINXM:user/release-keys \
    DeviceName=breeze \
